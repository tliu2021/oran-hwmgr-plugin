...
type RhprotoResourceSelectorGetResponse struct {
	ResourceProfileId *string                                    `json:"ResourceProfileId,omitempty"`
	Filters           *RhprotoResourceSelectorGetResponseFilters `json:"filters,omitempty"`
	NumResources      *float32                                   `json:"numResources,omitempty"`
	Resources         *[]RhprotoResource                         `json:"resources,omitempty"`
	RpId              *string                                    `json:"rpId,omitempty"`
}

// RhprotoResourceSelectorGetResponseFilters defines model for rhprotoResourceSelectorGetResponse_filters.
type RhprotoResourceSelectorGetResponseFilters struct {
	Exclude *map[string]interface{}                           `json:"exclude,omitempty"`
	Include *RhprotoResourceSelectorGetResponseFiltersInclude `json:"include,omitempty"`
}

// RhprotoResourceSelectorGetResponseFiltersInclude defines model for rhprotoResourceSelectorGetResponse_filters_include.
type RhprotoResourceSelectorGetResponseFiltersInclude struct {
	Labels *[]RhprotoResourceSelectorGetResponseFiltersIncludeLabels `json:"labels,omitempty"`
}

// RhprotoResourceSelectorGetResponseFiltersIncludeLabels defines model for rhprotoResourceSelectorGetResponse_filters_include_labels.
type RhprotoResourceSelectorGetResponseFiltersIncludeLabels struct {
	Key   *string `json:"Key,omitempty"`
	Value *string `json:"Value,omitempty"`
}
...
type ServerInterface interface {
	...
	// (GET /v1/tenants/default_tenant/jobs/{jobid})
	VerifyRequestStatus(w http.ResponseWriter, r *http.Request, jobid string)
	// Create Resource Group
	// (POST /v1/tenants/default_tenant/resourcegroups)
	CreateResourceGroup(w http.ResponseWriter, r *http.Request)
	// Delete Resource Group
	// (DELETE /v1/tenants/default_tenant/resourcegroups/{resource-group-id})
	DeleteResourceGroup(w http.ResponseWriter, r *http.Request, resourceGroupId string)
	// Get Resource Group
	// (GET /v1/tenants/default_tenant/resourcegroups/{resource-group-id})
	GetResourceGroup(w http.ResponseWriter, r *http.Request, resourceGroupId string)
}
...
func (siw *ServerInterfaceWrapper) VerifyRequestStatus(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.VerifyRequestStatus(w, r, jobid)
	}))
...
func (siw *ServerInterfaceWrapper) CreateResourceGroup(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateResourceGroup(w, r)
	}))
...
func (siw *ServerInterfaceWrapper) DeleteResourceGroup(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.DeleteResourceGroup(w, r, resourceGroupId)
	}))
...
func (siw *ServerInterfaceWrapper) GetResourceGroup(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetResourceGroup(w, r, resourceGroupId)
	}))
...
func HandlerWithOptions(si ServerInterface, options GorillaServerOptions) http.Handler {
	...
	r.HandleFunc(options.BaseURL+"/v1/tenants/default_tenant/jobs/{jobid}", wrapper.VerifyRequestStatus).Methods("GET")

	r.HandleFunc(options.BaseURL+"/v1/tenants/default_tenant/resourcegroups", wrapper.CreateResourceGroup).Methods("POST")

	r.HandleFunc(options.BaseURL+"/v1/tenants/default_tenant/resourcegroups/{resource-group-id}", wrapper.DeleteResourceGroup).Methods("DELETE")

	r.HandleFunc(options.BaseURL+"/v1/tenants/default_tenant/resourcegroups/{resource-group-id}", wrapper.GetResourceGroup).Methods("GET")
